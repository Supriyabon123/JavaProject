...
<body>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <div class="dropdown">
    <button class="btn" type="button" data-toggle="dropdown">Registration
   </button>
    <ul class="dropdown-menu">
      ...
      <li><a href="#">Teacher Registration</a></li>
                                            ...
                                            <div class="dropdown">
    <button class="btn active dropdown-toggle" type="button" data-toggle="dropdown">Login
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="course-content">
                            ...
                            <a href="CProgramminglang.jsp"><h4>Programming languages</h4></a>
                           
                            <p>C<br>Cpp<br>Java<br>.Net languages<br><br><br><br></p>
                        </div>
                        <!-- Seat Rating Fee -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="course-content">
                            ...
                            <a href="Scriptinglang.jsp"><h4>Scripting Languages</h4></a>
                          
                            <p>HTML<br>CSS<br>JavaScript<br>PHP<br><br><br><br></p>
                        </div>
                        <!-- Seat Rating Fee -->
                        <div class="seat-rating-fee d-flex justify-content-between">
                            <div class="seat-rating h-100 d-flex align-items-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="750ms">
                        ...
                        <div class="course-content">
                            ...
                            <a href="Databaselang.jsp"><h4>Database Technologies</h4></a>
                           
                            <p>Oracle<BR>MySql<BR>Sql<BR>MongoDB</p>
                        </div>
                        <!-- Seat Rating Fee -->
                        <div class="seat-rating-fee d-flex justify-content-between">
                            <div class="seat-rating h-100 d-flex align-items-center">
